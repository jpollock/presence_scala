...
import com.example.domain.UserPresenceState
...
class PresenceServiceIntegrationSpec
    extends AnyWordSpec
    with Matchers
  ...
  private val client = testKit.getGrpcClient(classOf[PresenceService])

  "PresenceService" must {
